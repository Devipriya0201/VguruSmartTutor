...
<table style="color:yellow;margin-left:350px;" id="tbl-student" class="table table-responsive table-bordered" cellpadding="100" width="500%">
<thead>
<tr>
<th>NAME</th>
<th>QUESTIONS</th>
...
<td><a class="j" href="10doubtsupdate.jsp?id=<%=id%>">Edit</a></td>
<td><a class="j" href="10doubtsdelete.jsp?id=<%=id%>">Delete</a></td>
</tr>
<%
		}
		}
