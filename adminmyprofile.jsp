...
<img  src="gif.gif" alt="Avatar" style="width:200px;margin-left:570px;">
   <br><br>   
      <%
...
try{
	...
	String u1=(String) session.getAttribute("thewname");
	ResultSet rs=st.executeQuery("select * from mentordetails where name='"+u1+"'");
	if(rs.next()){
%>
<form name="form" action="adminmyprofile.jsp" method="post">
<div align="center">
  ...
  Connection con=null;
   ...
   String url = "jdbc:mysql://localhost:3306/smarttutor?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    ...
    if(a!=null && b!=null && c!=null && d!=null && e!=null && g!=null){
        ...
        stmt.close();
        con.close();
        response.sendRedirect("adminmyprofile.jsp");
    }
    %>
