...
<img  src="fif.gif" alt="Avatar" style="width:200px;margin-left:570px;">
   <br><br>   
      <%
...
try{
	...
	ResultSet rs=st.executeQuery("select * from userdetailss where name='"+u1+"'");
	if(rs.next()){
%>
<form name="form" action="myprofile.jsp" method="post">
<div align="center">
...
<div align="center">
<lable style="color:white" class="form-lable">PARENT'sNAME</lable>
<br>
<input type="text" style="height:40px;width:390px" class="form-controler" value="<%= rs.getString(7) %>"  name="pna" id="name" required>
</div>

<div align="center">
<lable style="color:white" class="form-lable">MOBILE</lable>
<br>
<input type="text" style="height:40px;width:390px"class="form-controler" value="<%= rs.getString(8) %>" name="mb"  id="name" required>
</div>
<div align="center">
<lable style="color:white" class="form-lable">PASSWORD</lable>
<br>
<input type="text" style="height:40px;width:390px" class="form-controler" value="<%= rs.getString(9) %>" name="pas"  id="name" required>
</div>
<br><br>
...
<%
  ...
  Connection con=null;
   ...
   String url = "jdbc:mysql://localhost:3306/smarttutor?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    ...
    String f=request.getParameter("pna");
    String g=request.getParameter("mb");
    String h=request.getParameter("pas");
    if(a!=null && b!=null && c!=null && d!=null && e!=null && f!=null && g!=null){
        String q="update userdetailss set name=?, lname=?, age=?, std=?,ema=?, pname=?, mob=?, pass=? where name='"+a+"'";
